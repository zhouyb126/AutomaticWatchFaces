...
struct WatchDatabase {
    let watchDatabase = [Watch(id:0,name: "Rolex Submariner", dial: "SubDial", secHand: Hand(image: "ExSecond", scale: 0.19), minHand: Hand(image: "ExMinute", scale: 0.044), hourHand: Hand(image: "ExHour", scale: 0.06),luminescent:true, alternative: [Watch(name: "Alt1", dial: "SubDial-1",date:WatchDate(positionX: 70.0, positionY: 0.0, color: .black))]),
                         ...
                         Watch(id:8,name: "Patek Philippe Nautilus", dial: "NauDial", secHand: Hand(image: "NauSecond", scale: 0.22), minHand: Hand(image: "NauMinute", scale: 0.053), hourHand: Hand(image: "NauHour", scale: 0.053),date:WatchDate(positionX: 75, positionY: -1, color: .black),alternative:[Watch(name: "Alt1",dial:"NauDial-1"),Watch(name: "Alt2",dial:"NauDial-2")]),
                         ...
                         Watch(id:10,name: "Apple Hermes", dial: "HermesDial", minHand: Hand(image: "HermesMinute", scale: 0.045), hourHand: Hand(image: "HermesHour", scale: 0.045),alternative:[Watch(name:"Alt1",dial:"HermesDial-1",secHand:Hand(image: "HermesSecond", scale: 0.17),date:WatchDate(positionY: -56.0, color: .white)),Watch(name:"Alt1",dial:"HermesDial-2",secHand:Hand(image: "HermesSecond", scale: 0.17),date:WatchDate(positionY: -56.0, color: .white)),Watch(name:"Alt1",dial:"HermesDial-3",secHand:Hand(image: "HermesSecond", scale: 0.17),date:WatchDate(positionY: -56.0, color: .white)),Watch(name:"Alt1",dial:"HermesDial-4",secHand:Hand(image: "HermesSecond", scale: 0.17),minHand:Hand(image: "HermesMinute-1", scale: 0.045),hourHand:Hand(image: "HermesHour-1", scale: 0.045),date:WatchDate(positionY: -56, color: .white))]),
                         ...
                         Watch(id:12,name: "Hublot Spirit of Big Bang", dial: "BBDial", secHand: Hand(image: "BBSecond", scale: 0.35), minHand: Hand(image: "BBMinute", scale: 0.06), hourHand: Hand(image: "BBHour", scale: 0.06), date: WatchDate(positionX: 0, positionY: -99, color: .white)),
                         ...
                         Watch(id:22,name: "Apple Hermes Bicolour", dial: "BiTDial", minHand: Hand(image: "BiTMinute", scale: 0.045), hourHand: Hand(image: "BiTHour", scale: 0.045),date:WatchDate(positionX: -2, positionY: -56, color: UIColor(red:0.98, green:0.90, blue:0.81, alpha:1.0),fontSize:20),biColour: BiColour(backgroundColor: UIColor(red:0.29, green:0.14, blue:0.18, alpha:1.0), rotationColor: UIColor(red:0.78, green:0.22, blue:0.32, alpha:1.0)),
                               alternative:[Watch(name: "Alt1",dial: "BiTDial-1",minHand: Hand(image: "BiTMinute-1", scale: 0.045), hourHand: Hand(image: "BiTHour-1", scale: 0.045),date:WatchDate(positionX: -2, positionY: -56, color: UIColor(red:0.94, green:0.49, blue:0.19, alpha:1.0),fontSize:20),biColour:BiColour(backgroundColor: UIColor(red:0.87, green:0.83, blue:0.76, alpha:1.0), rotationColor: UIColor(red:0.15, green:0.18, blue:0.24, alpha:1.0)))]),
